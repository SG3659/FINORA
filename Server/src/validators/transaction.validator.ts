import { z } from "zod"
import { TransactionTypeEnum, RecurringIntervalEnum, PaymentMethodEnum } from "../model/transaction.model.js"
...
export const baseTransactionSchema = z.object({
   ...
   type: z.enum([TransactionTypeEnum.INCOME, TransactionTypeEnum.EXPENSE], "Type must be INCOME or EXPENSE"),
