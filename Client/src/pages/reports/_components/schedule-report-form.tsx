...
import { useUpdateReportSettingMutation } from "@/api/report/reportApi";
...
const ScheduleReportForm = ({
   ...
   const onSubmit = async (values: FormValues) => {
      try {
         ...
         await updateReportSetting(payload)
            .unwrap()
         ...
         const errorMessage = (error as { data?: { message?: string } })?.data?.message || "Failed to update report setting";
