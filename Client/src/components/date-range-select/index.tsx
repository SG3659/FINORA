...
import { DateRangeEnum, DateRangePreset, DateRangeSelectProps } from "@/@types/analytic"
      ...
      <Popover open={open} onOpenChange={setOpen}>
         <PopoverTrigger asChild>
            <Button
               variant="outline"
               className={cn(
                  `w-[160px] flex items-center justify-between text-left font-normal !bg-[var(--secondary-dark-color)]
            border-gray-200 !text-foreground !cursor-pointer`,
            ...
            <div className="grid py-1">
               {presets.map((preset) => (
                  <Button
                     ...
                     variant="ghost"
                     className={cn(
                        "justify-start text-left !hover:bg-muted-foreground",
