...
import { _TransactionFrequency, _TransactionType, Categories, PaymentMethods } from "@/@types/transaction/transactionTypes"
...
const TransactionForm = (props: {
   ...
   const { isEdit = false, transactionId, onCloseDrawer } = props
   ...
   const onSubmit = async (values: FormValue) => {
      try {
         ...
         const errorMessage = (error as { data?: { message?: string } })?.data?.message || "Failed to create transaction. Please try again."
               ...
               <div className="space-y-6">
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                        ...
                        `,
                                    field.value === _TransactionType.INCOME &&
                                    "!border-primary"
                                 )}
                              >
                                 <RadioGroupItem
                              ...
                              <label
                                 htmlFor={_TransactionType.EXPENSE}
                                 className={cn(
                                    `text-sm font-normal leading-none cursor-pointer
                        flex items-center space-x-2 rounded-md 
                        shadow-sm border p-2 flex-1 justify-center 
                        `,
                                    field.value === _TransactionType.EXPENSE &&
                                    "!border-primary"
                                 )}
                              >
                                 <RadioGroupItem
